...
/**
 * TempTableInfoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class TempTableInfoId  implements java.io.Serializable {
    ...
    /** default constructor */
    public TempTableInfoId() {
    }

    
    /** full constructor */
    public TempTableInfoId(String bulletinId, Short tableType) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TempTableInfoId) ) return false;
		 TempTableInfoId castOther = ( TempTableInfoId ) other; 
