...
/**
 * TempTableInfo entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="temp_table_info"
    ,catalog="CFDC"
)

public class TempTableInfo  implements java.io.Serializable {


    // Fields    

     private TempTableInfoId id;
     private String unit;
	...
	/** minimal constructor */
    public TempTableInfo(TempTableInfoId id) {
        this.id = id;
    }
    
    /** full constructor */
    public TempTableInfo(TempTableInfoId id, String unit, Short pdPage, String time, Short monthRange, Short currencyType, String content) {
        this.id = id;
        this.unit = unit;
        this.pdPage = pdPage;
        this.time = time;
    ...
    public TempTableInfoId getId() {
        return this.id;
    }
    
    public void setId(TempTableInfoId id) {
        this.id = id;
    }
