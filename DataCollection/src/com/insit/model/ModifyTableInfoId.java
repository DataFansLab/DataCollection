...
/**
 * ModifyTableInfoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class ModifyTableInfoId  implements java.io.Serializable {
    ...
    /** default constructor */
    public ModifyTableInfoId() {
    }

    
    /** full constructor */
    public ModifyTableInfoId(String bulletinId, Short tableType) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ModifyTableInfoId) ) return false;
		 ModifyTableInfoId castOther = ( ModifyTableInfoId ) other; 
